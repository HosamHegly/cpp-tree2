...
string Tree::find(string name)
{
     ...
     if(this->root->left!=NULL&&this->find(name,this->root->left,name)!="not found in the tree"&&this->find(name,this->root->left,name)!=" ")
     return this->find(name,this->root->left,name);
     if(this->root->right&&this->find(name,this->root->right,name)!="not found in the tree"&&this->find(name,this->root->right,name)!=" ")
...
{
    if(this->root->data==name)
     throw runtime_error( "cant remove root of the tree");
